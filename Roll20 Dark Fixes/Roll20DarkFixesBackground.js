...
var attemptApplication = (setting, settingName, settingType, fixCSS) => {
    ...
    if (!document.getElementById(`Roll20DarkFix_${settingType}`)) {
        ...
        if (!document.head) {
            ...
            console.log(
                `%cRoll20DarkFix: Elements not found. Waiting ${applicationInterval} milliseconds to attempt injecting again. Please open your character sheet.`,
                "color: yellow;"
            );
        ...
        if (setting == "enabled") {
            ...
            console.log(
                `%cRoll20DarkFix: The styling for ${settingName} was successfully added.`,
                "color: #32CD32;"
            );
        } else if (setting == "disabled") {
            // Log in the console that the setting is disabled.
            console.log(
                `%cRoll20DarkFix: Setting for ${settingName} is "disabled." Continuing to the next setting.`,
                "color: #32CD32;"
            );
        } else {
            ...
            console.log(
                `%cRoll20DarkFix: Setting for ${settingName} is not set properly. Please ensure that all settings are configured properly.`,
                "color: red;"
            );
            console.log("%c---------------------------------------------", "color: red;");
        }
        ...
        console.log(
            `%cRoll20DarkFix: The style fixes are already applied. Skipping attempted application.`,
            "color: #32CD32;"
        );
    }
};
...
function roll20DarkFixChatSkillBackground() {
    ...
    let fixCSS =
        'div.sheet-rolltemplate-skill div.sheet-container {background-image: url("https://i.imgur.com/FjwWl2K.png") !important;background-color: transparent !important;}';
